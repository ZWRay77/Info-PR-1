...
void ausgeliehenausgeben(std::vector<Medium*>& medien);
...
int main()
{
    ...
    char abfrage;
    do  // Anzeige des Menue
    {
        std::cout << std::endl
                  << "Menue:" << std::endl
                  << "-----------------------------" << std::endl
                  << "(1): Medium hinzufuegen" << std::endl
                  << "(2): Medium loechen" << std::endl
...
////////////////////////////////////////////////////
std::ostream& operator << (std::ostream& stream, Medium& medium)
{
    return medium.ausgabe(stream);
}
...
void ausgeliehenausgeben(std::vector<Medium*>& medien)
{
    std::cout << "Alle ausgeliehene Medien:" << std::endl;
    ...
    if (leer != true)
    {
        std::cout << "Keine ausgeliehene Medien" << std::endl;
    }
